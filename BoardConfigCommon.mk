...
ifeq ($(wildcard device/oneplus/xigua-kernel),)
# DTB / DTBO
...
BOARD_VENDOR_KERNEL_MODULES_LOAD := $(strip $(shell cat $(COMMON_PATH)/../xigua-kernel/modules.load))
else
...
ifeq ($(TARGET_DEVICE),xigua)
BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD := $(strip $(shell cat $(COMMON_PATH)/../xigua-kernel/modules.load.recovery))
else
BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD := $(strip $(shell cat $(COMMON_PATH)/modules.load.recovery))
endif
ifeq ($(TARGET_DEVICE),xigua)
BOOT_KERNEL_MODULES := $(strip $(shell cat $(COMMON_PATH)/../xigua-kernel/modules.load.recovery $(COMMON_PATH)/modules.include.vendor_ramdisk))
else
